...
- # Level 1
    - # Stage 1. Laboratory. Initializing protocol
        ...
        - Далее долгий коридор в котором раставленно старое обурудоваение с которым можно взаимоедйствовать. Оно что-то пиликает при включениие отключется. Если пройти немного дальше, то сверху отвалится решетка. Которая упадет на голову герою.(15%)
            - Ящер заверищит от боли и начнет прокленать все на свете.
            - Еж просто скажет "ауч" и пойдет дальше.
        ...
        - Здесь появляются первые турели. Героям прийдеться из отпиздить.(55%)
            - Ящер может попытаться обходить их со спины при помощи решеток.
            - Еж подбирать ящики и бросать их.
