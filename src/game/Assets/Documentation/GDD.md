...
- # UI
    ...
    Приблизительный внешний вид капсул с мутагеном, но они и все остальные иконки должно быть в стиле хайтек и киберпанк:
...
- # World
    ...
    На уровнях обязательно будут неявные подсказки как часть мира (указатели,надписи на стенах, лампы, следы, трещины, голосовые сообщения от компьютеров, останки и развалины, трупы, направление движения тараканов и тд). 

    Возможны сюжетные повороты: при игре вдвоём - второй игрок под конец сюжета может стать пришельцем / перейти на их сторону, при сингл плеере второй игрок может появляться как нпс и либо помогать либо мешать в разных квестах.
